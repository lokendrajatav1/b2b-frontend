...
const services = [
  { id: 1, label: "Machine Parts", icon: Settings, color: "text-[#007367]", bg: "bg-[#007367]/5" },
  ...
  { id: 6, label: "Drugs & Pharma", icon: Pill, color: "text-[#007367]", bg: "bg-[#007367]/5" },
  ...
  { id: 13, label: "IT & Computers", icon: Monitor, color: "text-blue-500", bg: "bg-[#007367]/5" },
  ...
  { id: 18, label: "Transport & Logistics", icon: Truck, color: "text-blue-700", bg: "bg-[#007367]/5" },
  ...
  { id: 21, label: "Education & Training", icon: BookOpen, color: "text-indigo-700", bg: "bg-[#007367]/5" },
  { id: 22, label: "Architects & Interiors", icon: Compass, color: "text-orange-700", bg: "bg-orange-50" },
  { id: 23, label: "HR & Recruitment", icon: Users, color: "text-blue-800", bg: "bg-[#007367]/5" },
      ...
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6">
        <div className="mb-16 px-4">
           <div className="space-y-4">
              <h2 className="text-[#007367] font-semibold  text-base uppercase flex items-center gap-2">
                <span className="w-8 h-px bg-[#007367]"></span>
                Sourcing Made Simple
              </h2>
              <h3 className="text-3xl md:text-5xl font-semibold text-[#0f172a] ">
                Explore Our <br />
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9 gap-4 md:gap-6 lg:gap-8">
          {services.map((service) => (
            ...
            >
              ...
              <span className="service-label text-base md:text-base lg:text-base font-semibold text-slate-800 text-center leading-tight  px-1 group-hover:text-[#007367] transition-colors">
                {service.label}
              </span>
            </Link>
          ))}
