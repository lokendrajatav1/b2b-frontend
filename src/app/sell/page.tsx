...
export default function SellWithUsPage() {
  const benefits = [
    { title: 'Hyper Local Reach', desc: 'Connect with buyers in your city and state with zero effort.', icon: TrendingUp, color: '#007367' },
    { title: 'Verified Trust', desc: 'Get a TrustSeal and boost your business credibility.', icon: ShieldCheck, color: '#e88c30' },
    { title: 'Sales Analytics', desc: 'Detailed insights into what buyers are looking for in your category.', icon: PieChart, color: '#007367' },
    { title: 'Instant Inquiries', desc: 'Receive real-time leads directly on your dashboard.', icon: Zap, color: '#e88c30' },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#f8faf9]">
      ...
      <section className="pt-28 pb-16 bg-white border-b border-gray-100 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[40%] h-full bg-gradient-to-l from-[#007367]/[0.02] to-transparent pointer-events-none" />
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 bg-[#e88c30]/[0.08] text-[#e88c30] text-base font-semibold px-4 py-1.5 rounded-full tracking-wide uppercase">
            ...
            <h1 className="text-3xl md:text-5xl font-semibold text-slate-900  leading-tight">
              ...
              with <span className="text-[#007367]">Confidence</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Link href="/(auth)/register" className="px-7 py-3.5 bg-[#007367] hover:bg-[#005e54] text-white rounded-xl font-medium text-base transition-all flex items-center gap-2.5 active:scale-[0.98]">
          ...
          <div className="relative">
             <div className="aspect-video bg-[#f8faf9] rounded-2xl border border-gray-100 overflow-hidden relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-[#007367]/[0.03] to-transparent" />
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg text-[#007367] group-hover:scale-110 transition-transform">
                      <Zap className="w-8 h-8 fill-[#007367]" />
                   </div>
                </div>
             </div>
             {/* Floating Badge */}
             <div className="absolute -bottom-4 -left-4 bg-white p-4 rounded-2xl border border-gray-100 shadow-md flex items-center gap-3">
                <div className="w-9 h-9 bg-[#007367]/10 text-[#007367] rounded-xl flex items-center justify-center">
           ...
           <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-7">
                 <h2 className="text-2xl md:text-3xl font-semibold text-slate-900 ">
                   Start selling in <br/><span className="text-[#007367]">3 Easy Steps</span>
                 </h2>
                 <div className="space-y-5">
                    {[
                      ...
                      <div key={idx} className="flex gap-5 items-start group">
                         <div className="text-3xl font-semibold text-gray-100 group-hover:text-[#007367]/20 transition-colors shrink-0 w-10">{item.step}</div>
                         <div>
              ...
              <div className="p-8 bg-[#f8faf9] rounded-2xl border border-gray-100 space-y-6">
                 ...
                 <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="p-4 bg-white rounded-xl border border-gray-100 hover:border-[#007367]/20 transition-colors cursor-pointer flex items-center justify-between group">
                         <span className="font-medium text-base text-slate-800 group-hover:text-slate-900 transition-colors">{q}</span>
                         <ArrowRight className="w-4 h-4 text-[#007367] opacity-40 group-hover:opacity-100 transition-opacity" />
                      </div>
                    ))}
                 </div>
              </div>
      ...
      <section className="py-16 px-6">
         <div className="max-w-7xl mx-auto p-10 md:p-14 bg-[#007367]/[0.04] rounded-2xl text-center border border-[#007367]/10">
            ...
            <div className="flex justify-center gap-3">
               <Link href="/(auth)/register" className="px-8 py-3.5 bg-[#007367] text-white rounded-xl font-medium text-base hover:bg-[#005e54] transition-all">Get Started Now</Link>
            </div>
         </div>
      </section>
    </div>
