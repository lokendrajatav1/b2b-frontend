  ...
  return (
    <div className="min-h-screen bg-[#f8faf9]">
      ...
      <section className="pt-28 pb-16 bg-white border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="p-2.5 bg-white border border-gray-200 rounded-lg flex flex-col md:flex-row gap-2">
              <div className="flex-1 flex items-center gap-3 px-4 py-3 bg-[#f8faf9] rounded-lg">
              ...
              <Link href="/search" className="px-7 py-3 bg-[#164e33] hover:bg-[#113f29] text-white rounded-lg font-medium text-base transition-all text-center">
                Search
              </Link>
            </div>
          </div>
          ...
          <div className="relative lg:block hidden">
             <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div 
                    key={i}
                    className="p-6 bg-white border border-gray-100 rounded-lg hover:shadow-md transition-all group cursor-default"
                  >
                     <div 
      ...
      <section className="py-16">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-5">
           {categories.map((cat, i) => (
              <div key={i} className="group p-6 bg-white border border-gray-100 rounded-lg hover:border-[#164e33]/20 hover:shadow-sm transition-all cursor-pointer">
      ...
      <section className="py-14 px-6">
        <div className="max-w-7xl mx-auto bg-[#164e33]/[0.04] border border-[#164e33]/10 rounded-lg p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
           ...
           <Link href="/post-requirement" className="px-7 py-3.5 bg-[#164e33] text-white rounded-lg font-medium text-base hover:bg-[#113f29] transition-all shrink-0">Post Requirement</Link>
        </div>
      </section>
    </div>
  );
