  ...
  return (
    <div className="min-h-screen bg-[#f8faf9]">
      ...
      <section className="pt-28 pb-16 bg-white border-b border-gray-100 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#007367]/[0.02] rounded-full -translate-y-1/3 translate-x-1/3 pointer-events-none" />
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-[#007367]/[0.08] text-[#007367] text-base font-semibold px-4 py-1.5 rounded-full mb-4 tracking-wide uppercase">
            ...
            <h1 className="text-3xl md:text-5xl font-semibold text-slate-900  leading-tight">
              ...
              <span className="text-[#007367]">Indian Commerce</span>
            </h1>
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Zap, title: 'Hyper Growth', desc: 'Work in a fast-paced environment where your impact is immediate.', color: '#007367' },
              { icon: Heart, title: 'Health & Wellness', desc: 'Comprehensive health insurance and mental wellness support for you and your family.', color: '#e88c30' },
              { icon: Star, title: 'Ownership', desc: 'Every employee gets ESOPs. We want you to own a piece of what you build.', color: '#007367' },
            ].map((perk, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-3">
            {openings.map((job, idx) => (
              <div 
                key={idx}
                className="p-5 md:p-6 bg-white border border-gray-100 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4 hover:shadow-md hover:border-[#007367]/20 transition-all cursor-pointer group"
              >
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 bg-[#007367]/[0.08] rounded-xl flex items-center justify-center text-[#007367] shrink-0">
                    <Briefcase className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-base font-semibold text-slate-900 group-hover:text-[#007367] transition-colors">{job.title}</h4>
                    <div className="flex items-center gap-3 mt-1">
                      <span className="text-base font-semibold text-[#e88c30] uppercase ">{job.dept}</span>
                ...
                <div className="flex items-center gap-4">
                   ...
                   <div className="w-9 h-9 bg-[#f8faf9] rounded-full flex items-center justify-center group-hover:bg-[#007367] group-hover:text-white text-slate-500 transition-all">
          ...
          <div className="mt-12 p-8 md:p-10 bg-[#007367]/[0.04] rounded-2xl text-center border border-[#007367]/10 relative overflow-hidden">
             <h3 className="text-lg font-semibold text-slate-900 mb-2">Don't see a fit?</h3>
             <p className="text-slate-500 mb-6 max-w-lg mx-auto text-base font-normal">We're always looking for brilliant minds. Send your resume to <span className="text-[#007367] font-medium">careers@b2b-india.com</span></p>
             <button className="px-8 py-3 bg-[#007367] text-white rounded-xl font-medium text-base hover:bg-[#005e54] transition-all">General Application</button>
          </div>
        </div>
      </section>
    </div>
