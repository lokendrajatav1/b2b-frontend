      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-100 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
           ...
           <div className="flex items-center gap-2 shrink-0">
              ...
              <button onClick={fetchLeads} className="p-2 bg-white border border-gray-200 rounded-xl text-slate-500 hover:text-[#164e33] hover:bg-[#164e33]/5 transition-all shadow-sm">
                  ...
                  <tr key={lead.id} className="group hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                       <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-base font-semibold uppercase  ${
                         ...
                         lead.status === 'DISTRIBUTED' ? 'bg-[#164e33]/5 text-slate-800 border border-[#164e33]/10' :
                         'bg-emerald-50 text-emerald-700 border border-emerald-100'
                       }`}>
                          <div className={`w-1 h-1 rounded-full ${
                             lead.status === 'PENDING' ? 'bg-amber-500' : 
                             lead.status === 'DISTRIBUTED' ? 'bg-[#164e33]/50' : 'bg-emerald-500'
                          }`}></div>
                      ...
                      <div className="space-y-4">
                          {categoryVendors.length > 0 ? (
                            categoryVendors.map(vendor => (
                              <div key={vendor.id} className="flex items-center justify-between p-5 bg-white border border-gray-100 rounded-xl hover:border-[#164e33]/30 hover:shadow-lg hover:shadow-[#164e33]/5 transition-all group">
                                ...
                                <button 
                                  ...
                                  className={`px-6 py-2.5 rounded-xl text-base font-semibold uppercase  transition-all ${selectedLead.vendor?.id === vendor.id ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-[#164e33] hover:bg-[#113f29] text-white shadow-lg shadow-[#164e33]/10'}`}
                                >
