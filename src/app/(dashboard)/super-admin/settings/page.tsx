    ...
    <div className="space-y-8 animate-simple-fade pb-20 p-2 md:p-0">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-100 max-w-6xl mx-auto">
        ...
        <button 
            onClick={handleSave}
            disabled={saving}
            className="px-5 py-2.5 bg-[#164e33] text-white rounded-xl font-semibold text-base flex items-center justify-center gap-2 disabled:opacity-50 shadow-sm transition-colors hover:bg-[#113f29]"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-1 space-y-2">
            {[
                ...
                <button
                    ...
                    className={`w-full p-4 rounded-xl text-left flex items-center gap-4 transition-colors ${ activeTab === tab.id ? 'bg-[#164e33]/10 text-[#164e33] font-semibold border-[#164e33]/20 shadow-sm' : 'text-slate-800 border border-transparent hover:bg-gray-50' }`}
                >
                    <tab.icon className={`w-5 h-5 shrink-0 ${activeTab === tab.id ? 'text-[#164e33]' : 'text-slate-500'}`} />
                    <div className="flex flex-col">
                        <span className="text-base font-semibold">{tab.label}</span>
                        <span className={`text-base ${activeTab === tab.id ? 'text-[#164e33]/80 font-medium' : 'text-slate-500'}`}>{tab.desc}</span>
                    </div>
                </button>
            ))}
        </div>
        ...
        {/* Content Node */}
        <div className="lg:col-span-3 bg-white rounded-xl border border-gray-100 p-6 md:p-8 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-[#164e33] focus:ring-4 focus:ring-[#164e33]/10 outline-none text-base transition-all"
                                />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-3">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-base font-semibold text-[#164e33] bg-[#164e33]/10 px-2 py-0.5 rounded border border-[#164e33]/20 uppercase ">Base Weight</span>
                                  </div>
                                  <input 
                                    type="range"
                                    min="0"
                            ...
                            <div className="space-y-4">
                                <div className="space-y-3">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-base font-semibold text-[#164e33] bg-[#164e33]/10 px-2 py-0.5 rounded border border-[#164e33]/20 uppercase ">Growth Weight</span>
                                  </div>
                                  <input 
                                    type="range"
                                    min="0"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-2">
                              ...
                              <input 
                                  ...
                                  className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-[#164e33] focus:ring-4 focus:ring-[#164e33]/10 outline-none font-medium text-slate-900 text-base transition-all"
                              />
                          </div>
                ...
                {activeTab === 'notifications' && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                        ...
                        {[
                            ...
                            <div key={n.title} className="p-5 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-between group/row hover:border-[#164e33]/20 hover:bg-white transition-all shadow-sm">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-white rounded-xl border border-gray-200 flex items-center justify-center text-slate-500 group-hover/row:text-[#164e33] group-hover/row:border-[#164e33]/20 transition-colors shadow-sm">
