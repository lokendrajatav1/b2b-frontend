  ...
  return (
    <div className="space-y-6 animate-simple-fade pb-20 p-2 md:p-0">
      ...
      <div className="flex flex-col gap-3 pb-6 border-b border-gray-100 max-w-7xl mx-auto">
        ...
        <div>
           <h1 className="text-xl font-bold text-slate-900 uppercase tracking-tight">Catalogue Review</h1>
           <p className="text-slate-500 font-medium text-[11px] uppercase tracking-wider">Moderate product listings</p>
        </div>
               ...
               <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-white shrink-0">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Verification Node 0x44</p>
                    </div>
                  </div>
