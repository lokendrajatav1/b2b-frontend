  ...
  if (authLoading || loading) {
     return (
        <div className="min-h-[60vh] flex items-center justify-center">
           <RefreshCcw className="w-10 h-10 text-[#007367] animate-spin" />
        </div>
     );
  }
    ...
    <div className="space-y-8 animate-simple-fade pb-20 p-2 md:p-0 font-medium">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-100 max-w-7xl mx-auto">
        <div className="space-y-1">
           <div className="flex items-center gap-2 text-[#e88c30] font-bold uppercase  text-base mb-1">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
         ...
         <div className="lg:col-span-4 space-y-8">
            <div className="bg-white rounded-none border border-gray-100 p-10 text-center shadow-sm relative overflow-hidden group">
               <div className="absolute top-0 left-0 w-full h-32 bg-linear-to-br from-[#007367] to-[#005e54] opacity-5 group-hover:opacity-10 transition-opacity" />
               
               <div className="relative mb-8 flex justify-center">
                  <div className="relative w-32 h-32">
                    <div className="w-full h-full bg-white rounded-none border-4 border-gray-50 flex items-center justify-center text-4xl font-bold text-[#007367] shadow-xl overflow-hidden group/img">
                       {user?.avatar ? (
                    ...
                    <div className="absolute bottom-0 right-0 p-2 bg-[#e88c30] text-white rounded-none shadow-lg border-2 border-white translate-x-2 translate-y-2">
               ...
               <p className="text-base font-bold text-[#e88c30] uppercase  mt-2">{user?.role === 'ADMIN' ? 'Strategic Administrator' : user?.role}</p>
               
               <div className="mt-10 pt-8 border-t border-gray-50 space-y-4 text-left">
                  <div className="p-4 bg-gray-50 rounded-none border border-gray-100 group/item hover:bg-white hover:border-[#007367]/20 transition-all">
                     <p className="text-base font-bold text-black uppercase  mb-1.5 flex items-center gap-1.5">
                        <Building2 className="w-3 h-3 text-[#007367]" /> Department Hub
                     </p>
                     <p className="text-base font-bold text-slate-900">{user?.admin?.department || 'Operations'}</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-none border border-gray-100 group/item hover:bg-white hover:border-[#007367]/20 transition-all">
                     <p className="text-base font-bold text-black uppercase  mb-1.5 flex items-center gap-1.5">
                        <MapPin className="w-3 h-3 text-[#007367]" /> Geographic Region
                     </p>
            ...
            <div className="bg-white rounded-none p-10 border border-gray-100 shadow-sm space-y-6">
               <div className="w-12 h-12 bg-[#007367]/5 rounded-none flex items-center justify-center">
                  <Key className="w-6 h-6 text-[#007367]" />
               </div>
               <div>
               ...
               <div className="space-y-3">
                  {['Encrypted Access', 'Global Visibility', 'Full Permissions'].map(p => (
                     <div key={p} className="flex items-center gap-3 text-base font-bold text-slate-900 uppercase ">
                        <CheckCircle2 className="w-4 h-4 text-[#007367]" />
                        {p}
                     </div>
                  ))}
               </div>
         ...
         {/* Main Form */}
         <div className="lg:col-span-8 bg-white rounded-none border border-gray-100 p-10 shadow-sm relative">
            <div className="flex items-center justify-between mb-10 pb-6 border-b border-gray-50">
               <h3 className="text-xl font-bold text-slate-900  uppercase ">Identity Profile</h3>
               <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-600 rounded-none border border-emerald-100 text-base font-bold uppercase ">
            ...
            <form onSubmit={handleUpdate} className="space-y-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                  <div className="space-y-3">
                     ...
                     <div className="relative group">
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-[#007367] transition-colors" />
                        <input 
                           type="text" 
                           value={formData.name}
                           onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                           className="w-full pl-12 pr-5 py-4 bg-gray-50 border border-transparent rounded-none text-base font-bold focus:bg-white focus:border-[#007367]/20 transition-all outline-none placeholder:text-gray-300"
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="relative">
                        ...
                        <input 
                           ...
                           disabled
                           className="w-full pl-12 pr-5 py-4 bg-gray-50/50 border border-transparent rounded-none text-base font-bold text-gray-300 cursor-not-allowed outline-none"
                        />
                     </div>
                  </div>
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="relative group">
                        <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-[#007367] transition-colors" />
                        <input 
                           type="tel" 
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="relative group">
                        <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-[#007367] transition-colors" />
                        <input 
                           type="text" 
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="relative group">
                        <Layers className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-[#007367] transition-colors" />
                        <input 
                           type="text" 
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="relative group">
                        <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-[#007367] transition-colors" />
                        <input 
                           type={showPassword ? "text" : "password"}
                           value={formData.password}
                           onChange={(e) => setFormData({ ...formData, password: e.target.value })}
                           className="w-full pl-12 pr-12 py-4 bg-gray-50 border border-transparent rounded-none text-base font-bold focus:bg-white focus:border-[#007367]/20 transition-all outline-none placeholder:text-gray-300"
                           placeholder="••••••••••••"
                        />
                        <button 
                           type="button"
                           onClick={() => setShowPassword(!showPassword)}
                           className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-[#007367]"
                        >
               ...
               <div className="pt-10 border-t border-gray-50 flex flex-col sm:flex-row items-center gap-4">
                  <button 
                    type="submit"
                    disabled={saving}
                    className="w-full sm:w-auto px-12 py-4.5 bg-[#007367] hover:bg-[#005e54] text-white rounded-none font-bold flex items-center justify-center gap-3 shadow-xl shadow-[#007367]/20 transition-all active:scale-95 disabled:opacity-50"
                  >
