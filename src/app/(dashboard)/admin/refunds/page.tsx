    ...
    <div className="space-y-8 animate-simple-fade pb-20 p-2 md:p-0">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-100 max-w-7xl mx-auto">
        <div>
           ...
           <p className="text-gray-500 font-medium mt-1 text-sm">Review, approve, or reject vendor refund requests globally.</p>
        </div>
            ...
            <table className="w-full text-left">
               <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-100">
                     <th className="px-6 py-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Date / Vendor</th>
                  ...
                  {loading ? (
                     ...
                     refunds.map((refund) => (
                        <tr key={refund.id} className="group hover:bg-gray-50/50 transition-colors">
                           ...
                           <td className="px-6 py-4 text-xs font-medium text-gray-500 max-w-[250px]">
                             {refund.reason}
                           </td>
                           <td className="px-6 py-4">
                     ...
                     <tr>
                        <td colSpan={5} className="py-24 text-center">
                           ...
                           <p className="text-sm font-semibold text-gray-400">No pending refunds.</p>
                        </td>
                     </tr>
                  )}
               </tbody>
