    ...
    <div className="space-y-8 animate-simple-fade pb-20 p-2 md:p-0 font-medium">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-100 max-w-7xl mx-auto">
        <div>
           ...
           <p className="text-slate-700 font-medium mt-1 text-base">Manage business on-boarding for your assigned hub.</p>
        </div>
            ...
            <div className="overflow-x-auto w-full">
               <table className="w-full text-left border-collapse">
                  ...
                  <tr className="bg-gray-50/50">
                     <th className="px-8 py-5 text-base font-semibold text-slate-500 uppercase ">Business Entity</th>
                     <th className="px-8 py-5 text-base font-semibold text-slate-500 uppercase ">Hub Location</th>
                     <th className="px-8 py-5 text-base font-semibold text-slate-500 uppercase ">Status</th>
                     <th className="px-8 py-5 text-base font-semibold text-slate-500 uppercase ">Joined</th>
                  ...
                  {loading ? (
                     ...
                     vendors.map((vendor) => (
                        <tr key={vendor.id} className="group hover:bg-gray-50/30 transition-all">
                           ...
                           <td className="px-8 py-5">
                            ...
                            <td className="px-8 py-5">
                               <div className={`inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-base font-semibold uppercase  border ${vendor.verified ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-amber-50 text-amber-600 border-amber-100'} transition-all`}>
                            ...
                            <td className="px-8 py-5 text-base font-semibold text-slate-500">
                     ...
                     <tr>
                        <td colSpan={5} className="py-32 text-center bg-gray-50/20">
                           ...
                           <h3 className="text-xl font-semibold text-slate-500 ">Everything Screened</h3>
                           <p className="text-base font-medium text-gray-300 max-w-xs mx-auto mt-2">No pending applications found in your hub registry.</p>
                        </td>
                     </tr>
                  )}
                </tbody>
               ...
               <div className="flex-1 overflow-y-auto p-12 space-y-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                     <div className="space-y-8">
                        ...
                        <section className="space-y-4">
                           <h4 className="text-base font-semibold text-black uppercase  pl-1 border-b border-gray-50 pb-2">Professional Presence</h4>
        ...
        {isRejectConfirmOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative bg-white p-8 max-w-md w-full shadow-2xl border border-gray-200"
            >
               <h3 className="text-xl font-semibold text-slate-900 mb-2">Confirm Rejection</h3>
               <p className="text-base text-slate-500 mb-6 font-medium">Are you sure you want to decline this application? This action will notify the vendor.</p>
