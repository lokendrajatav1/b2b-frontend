        ...
        <div className="flex items-center gap-3">
           <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-100 rounded-xl text-base font-semibold outline-none focus:bg-white focus:border-[#164e33] transition-all"
              />
           </div>
           ...
           <select 
             ...
             className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-base font-semibold text-slate-800 outline-none focus:border-[#164e33] appearance-none cursor-pointer shadow-sm min-w-[140px]"
           >
           ...
           <button onClick={fetchLeads} className="p-2.5 bg-white border border-gray-200 rounded-xl text-slate-500 hover:text-[#164e33] transition-all shadow-sm">
                  ...
                  <tr key={lead.id} className="group hover:bg-gray-50/50 transition-colors">
                    <td className="px-8 py-5">
                        <div className="flex flex-col">
                            <span className="text-base font-semibold text-slate-900 leading-tight group-hover:text-[#164e33] transition-colors">
          ...
          <>
             ...
             >
               ...
               <div className="flex-1 overflow-y-auto p-10 space-y-10">
                   <div className="bg-gray-50/50 p-8 rounded-xl border border-gray-100 flex gap-6 items-center shadow-inner">
                      <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center text-[#164e33] border border-[#164e33]/10 shrink-0 shadow-lg">
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="p-8 bg-white border border-gray-100 rounded-xl text-base text-slate-800 font-semibold leading-relaxed italic shadow-sm border-l-4 border-[#f58220]">
                   ...
                   <div className="pt-10 border-t border-gray-50 space-y-6">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-semibold text-[#164e33] bg-[#164e33]/5 px-3 py-1 rounded-full uppercase er">{categoryVendors.length} Hub Partners Available</span>
                      </div>
                      
                      <div className="space-y-4">
                          {categoryVendors.length > 0 ? (
                            categoryVendors.map(vendor => (
                              <div key={vendor.id} className="flex items-center justify-between p-4 bg-white border border-gray-100 rounded-xl hover:border-[#164e33]/30 hover:shadow-md transition-all group">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2">
                                          <span className="text-base font-semibold text-slate-900 block group-hover:text-[#164e33] transition-colors">{vendor.businessName}</span>
                                          {!vendor.verified && (
                                            <span className="px-1.5 py-0.5 bg-amber-100 text-amber-700 text-[10px] font-bold rounded-md uppercase tracking-wider">Unverified</span>
                                          )}
                                        </div>
                                ...
                                <button 
                                  ...
                                  className={`px-5 py-2.5 rounded-xl text-sm font-semibold uppercase tracking-wide transition-all ${selectedLead.vendor?.id === vendor.id ? 'bg-emerald-50 text-emerald-600 border border-emerald-100 cursor-default' : 'bg-[#164e33] hover:bg-[#113f29] text-white shadow-sm'}`}
                                >
