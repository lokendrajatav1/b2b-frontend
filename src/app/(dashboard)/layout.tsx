    ...
    <div className="min-h-screen bg-[#fcfcfc] text-slate-900 flex font-sans antialiased">
      ...
      >
        ...
        <header
          ...
          className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-6 lg:px-10 sticky top-0 z-30"
        >
          <div className="flex items-center gap-6">
            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
              className="lg:hidden p-2 rounded-lg text-slate-700 hover:bg-gray-50 transition-colors"
            >
              {mobileMenuOpen ? (
                <X className="w-5 h-5" />
              ) : (
            ...
            <div ref={profileRef} className="relative">
              ...
              >
                <div className="px-3 py-3 border-b border-gray-50 mb-1 sm:hidden">
                  <p className="text-sm font-bold text-slate-900 capitalize leading-none mb-1">
                    {user.name}
                  </p>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3.5 py-3 text-sm font-bold text-slate-600 hover:text-[#164e33] hover:bg-[#164e33]/5 rounded-lg transition-all"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3.5 py-3 text-sm font-bold text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"
                >
