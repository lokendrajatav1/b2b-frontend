    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-semibold text-slate-900 ">Super Admin Portal</h2>
            <p className="text-slate-500 text-base font-medium mt-1">System administration and global controls.</p>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 p-8 sm:p-10">
            ...
            <div className="space-y-6">
               ...
               <AnimatePresence mode="wait">
                  <motion.form key="email" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} onSubmit={handleSubmit} className="space-y-6">
